...
public enum ErroSintaxeEnum {
	...
	PALAVRA_SE_NAO_ENCONTRADA(9, "Palavra-chave \'Se\' não encontrada."),
	PALAVRA_ENTAO_NAO_ENCONTRADA(10, "Palavra-chave \'Entao\' não encontrada."),
	PALAVRA_FIMSE_NAO_ENCONTRADA(11, "Palavra-chave \'Fimse\' não encontrada.");
